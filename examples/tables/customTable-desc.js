...
import Example from './customTable'

import SyntaxHighlighter from 'react-syntax-highlighter/prism';


class CustomTable_desc extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        return (
            <div>
                <p style={{ paddingBottom: '10px', fontSize: '20px' }} >自定义表格</p>
                <p>允许自定义列内容，自定义单元格内容，自定义行样式和事件，自定义单元格样式和事件</p>
                <p>onRow 、 onCell返回的是tr或td可识别的属性即可</p>
                <Example />
...
export default CustomTable_desc